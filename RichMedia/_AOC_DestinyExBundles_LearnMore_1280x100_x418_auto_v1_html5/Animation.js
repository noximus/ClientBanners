var home_animation = {
  ...
  container: document.getElementById("container"),
	...
	expand_btn: document.getElementById("click_to_expand"),
  ...
  frame1: function () {
	  ...
	  frame2: function () {
		TweenLite.to(prize, .5, {opacity: 0, ease: Linear.eastOut});
		TweenLite.to(enter, .5, {opacity: 0, display: 'none', ease: Linear.easeOut});
		TweenLite.to(tweet, .5, {delay:.5, display: 'block', opacity: 1, ease: Linear.easeIn});
		TweenLite.delayedCall(3, home_animation.frame3);
	},
	frame3: function () {
		TweenLite.to(tweet, .5, {opacity: 0, display: 'none', ease: Linear.easeOut});
		TweenLite.to(heroFrame, .5, {delay:.5, display: 'block', ease: Linear.easeIn});
		TweenLite.to(herosbg, .5, {delay:.8, display: 'block', opacity:1, ease: Linear.easeIn});
		TweenLite.to(hashtag, .5, {delay:1.3, display: 'block', opacity:1, ease: Linear.easeIn});
		TweenLite.to(noPurch, .5, {delay:1.5, display: 'block', opacity:1, ease: Linear.easeIn});
    	TweenLite.delayedCall(3, home_animation.frame4);
	},
	frame4: function () {
		TweenLite.to(heroFrame, .5, {opacity:0, display: 'none', ease:Linear.easeInOut});
		TweenLite.to(expand_btn, .5, {opacity:0, display: 'none', ease:Linear.easeInOut});
		...
		TweenLite.to(greatness, .5, {delay: .5, opacity: 1, display:'block', ease: Linear.easeIn});
		TweenLite.to(bundlesweeps, .5, {delay:1, opacity:1, display: 'block', ease:Linear.easeIn});
		TweenLite.to(lrnBtn, .5, {delay: 1.5, opacity: 1, display:'block', ease: Linear.easeIn});
		TweenLite.delayedCall(3, home_animation.frame1Ex);
	},  
	...
	frame1Ex: function () {
		...
		TweenLite.to(prizeEx, .5, {delay:.8, opacity: 1, ease: Linear.eastOut});
		TweenLite.delayedCall(3, home_animation.frame2Ex);
	},  
	frame2Ex: function () {
		TweenLite.to(prizeEx, .5, {opacity: 0, ease: Linear.eastOut});
		TweenLite.to(enterEx, .5, {opacity: 0, display: 'none', ease: Linear.easeOut});
		TweenLite.to(tweetEx, .5, {delay:.5, display: 'block', opacity: 1, ease: Linear.easeIn});
		TweenLite.delayedCall(3, home_animation.frame3Ex);
	},  
	frame3Ex: function () {
		TweenLite.to(tweetEx, .5, {opacity: 0, display: 'none', ease: Linear.easeOut});
		TweenLite.to(heroFrameEx, .5, {delay:0, display: 'block', ease: Linear.easeIn});
		TweenLite.to(herosbgEx, .5, {delay:.5, display: 'block', opacity:1, ease: Linear.easeIn});
