var home_animation = {
  ...
  frame4Out: function () {
    TweenLite.to(heroFrame, 0, {opacity:0, display: 'none', ease:Linear.easeInOut});
    TweenLite.to(logo, 0, {opacity:0, display: 'none', ease:Linear.easeInOut});
    TweenLite.to(learnMore, 0, {opacity:0, display: 'none', ease:Linear.easeInOut});
    TweenLite.to(finalFrame, 0, {delay: 1, opacity: 1, display: 'block', ease: Linear.easeIn});
    TweenLite.to(greatness, 0.5, {delay: 1, opacity: 1, display:'block', ease: Linear.easeIn});
    TweenLite.to(bundlesweeps, 1, {delay:1.5, opacity:1, display: 'block', ease:Linear.easeIn});
    TweenLite.to(lrnBtn, 1.5, {delay: 3, opacity: 1, display:'block', ease: Linear.easeIn});
  },
  frame1Ex: function () {
  ...
  frame4Ex: function () {
    ...
    TweenLite.to(lrnBtnEx2, 0.5, {delay: 3, opacity: 1, display:'block', ease: Linear.easeIn});
  }
};
